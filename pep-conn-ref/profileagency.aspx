						...
						<asp:label id="lblMsg" runat="server" ForeColor="Red"></asp:label>
							...
							<form id="frm" class="agency-form" method="post" runat="server">
                                <div class="agency-form-row">
								    ...
								    <div class="agency-form-row row2">
                                        <div class="form-row-item item1">
                                            <div class="input-row">
                                            <label>City:</label>
                                        ...
                                        <div class="form-row-item item2">
                                            <div class="item2-row1">
                                                 <div class="input-row state">
                                                    <label>State:</label>
                                    ...
                                    <div class="agency-form-row row3">
